...
{
    public class OBSActionsFactory : IComponentFactory
    {
        // The displayed name of the component in the Layout Editor.
        public string ComponentName => "OBS Actions";

        public string Description => "Performs Actions in OBS based on events from splits";

        // The sub-menu this component will appear under when adding the component to the layout.
        public ComponentCategory Category => ComponentCategory.Information;

        public IComponent Create(LiveSplitState state) => new OBSActionsComponent(state);
        ...
        public string UpdateURL => "https://github.com/Alex-Marek/LiveSplit.OBSActions/tree/main";
